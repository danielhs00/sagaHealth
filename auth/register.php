            ...
            <div class="auth-form-card">
                ...
                <form id="register-form" novalidate>
                    ...
                    <div class="auth-input-group">
                        ...
                        <span class="input-error" id="reg-name-error"></span>
                    </div>
                    ...
                    <div class="auth-input-group">
                        <label for="reg-phone">Nomer HP</label>
                        <div class="input-with-icon">
                        ...
                        <span class="input-error" id="reg-phone-error"></span>
                    </div>
                    ...
                    <div class="auth-input-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input 
                                ...
                                required 
                                minlength="6">
                            <i class="fas fa-eye toggle-password" onclick="togglePassword('reg-password', this)" title="Tampilkan password"></i>
                        </div>
                    ...
                    <div class="auth-input-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input 
                                ...
                                autocomplete="new-password"
                                required>
                            <i class="fas fa-eye toggle-password" onclick="togglePassword('reg-password-confirm', this)" title="Tampilkan password"></i>
                        </div>
                        <span class="input-error" id="reg-password-confirm-error"></span>
                    </div>

                    <!-- Terms Checkbox -->
                    <div class="auth-terms">
                        <input type="checkbox" id="reg-terms" required>
                        <label for="reg-terms">Saya menyetujui <a href="../partials/syarat_ketentuan.php" target="_blank">Syarat & Ketentuan</a> dan <a href="../partials/pemberitahuan_privasi.php" target="_blank">Kebijakan Privasi</a> SagaHealth.</label>
                    </div>
                    <span class="input-error" id="reg-terms-error"></span>

                    <!-- Submit Button -->
                    <button type="submit" class="auth-button" id="reg-btn">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            passwordInput.addEventListener('input', () => {
                ...
                if (password.length > 0) {
                    ...
                    const { strength, strengthLabel, color } = checkPasswordStrength(password);
            ...
            function validateForm() {
                ...
                // Validate name
                if (!name) {
                    showFieldError('reg-name', 'Nama lengkap harus diisi');
                    isValid = false;
                ...
                if (!password) {
                    ...
                    showFieldError('reg-password', 'Kata sandi minimal 6 karakter');
                    isValid = false;
                }
            ...
            nameInput.addEventListener('input', () => {
                if (nameInput.value.trim()) clearFieldError('reg-name');
            });

            emailInput.addEventListener('input', () => {
                if (emailInput.value.trim()) clearFieldError('reg-email');
            });

            passwordConfirmInput.addEventListener('input', () => {
                if (passwordConfirmInput.value) clearFieldError('reg-password-confirm');
            });

            termsCheckbox.addEventListener('change', () => {
                if (termsCheckbox.checked) clearFieldError('reg-terms');
            });
            ...
            registerForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    if (data.status === 'success') {
                        ...
                        showMessage(data.message || 'Registrasi gagal. Silakan coba lagi.', 'error');
