    ...
    <main class="main-dashboard">
        <div class="container-wrapper">
            ...
            <section class="feature-grid" id="feature-grid">
                ...
                <a href="indexmood.php" class="feature-card accent-blue feature-basic" data-feature="mood" aria-label="Mood Tracker">
                ...
                <a href="tantangan.php" class="feature-card accent-orange feature-basic" aria-label="Tantangan 30 Hari">
                    <div class="card-icon"><i class="fas fa-trophy" aria-hidden="true"></i></div>
                    <h3>Tantangan 30 Hari</h3>
                    <p>Bangun kebiasaan sehat dengan target harian.</p>
                </a>

                <a href="progress.php" class="feature-card accent-purple feature-basic" aria-label="Progress Tracking">
                ...
                <a href="support.php" class="feature-card accent-red feature-basic" aria-label="Prioritas Support">
                ...
                <a href="konten.php" class="feature-card accent-black feature-basic" aria-label="Konten Eksklusif">
