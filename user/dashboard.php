    ...
    <main class="main-dashboard">
        <div class="container-wrapper">
            ...
            <section class="feature-grid" id="feature-grid">
                ...
                <a href="tantangan.php" class="feature-card accent-orange feature-premium" aria-label="Tantangan 30 Hari">
                ...
                <a href="progress.php" class="feature-card accent-purple feature-premium" aria-label="Progress Tracking">
